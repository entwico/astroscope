...
```bash
npm install @astroscope/components
```
...
```ts
import { Seo, JsonLd, JsonScript, WithNoBfCache, SmoothHashScroll } from '@astroscope/components/astro';
```
...
```astro
---
import { Page } from '@astroscope/components/astro';
import type { WebpageMetadata } from '@astroscope/components';
...
```astro
---
import { PreloadFont } from '@astroscope/components/astro';
...
```astro
---
import { PageMetadata } from '@astroscope/components/astro';
import type { WebpageMetadata } from '@astroscope/components';
...
```astro
---
import { JsonLd } from '@astroscope/components/astro';
...
```astro
---
import { JsonScript } from '@astroscope/components/astro';
---
...
```astro
---
import { WithNoBfCache } from '@astroscope/components/astro';
---
...
```astro
---
import { SmoothHashScroll } from '@astroscope/components/astro';
---
